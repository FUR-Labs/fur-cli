...
fn delete_fur_and_recover_from_chats() {
    ...
    fs::write(format!(".fur/threads/{}.json", tid), format!(r#"{{"id":"{}","title":"Hello","created_at":"2026-08-09T01:23:14Z","messages":["m1","m2","m3"],"tags":["demo"],"schema_version":"0.3"}}"#, tid)).unwrap();
