...
pub fn load_index_and_conversation(fur_dir: &Path) -> (Value, Value, String) {
...
pub fn load_conversation_messages(fur_dir: &Path, conversation: &Value) -> HashMap<String, Value> {
